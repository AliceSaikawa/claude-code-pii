...
import { isPIIFilterEnabled } from '../../services/pii/config.js'
...
function PIIFilterIndicator(): React.ReactNode {
  if (!isPIIFilterEnabled()) return null;
  return <Text color="green" wrap="truncate">PII Filter</Text>;
}
